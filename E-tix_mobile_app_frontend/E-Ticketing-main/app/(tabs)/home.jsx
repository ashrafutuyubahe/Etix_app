...
const Home = () => {
  ...
  const HandleContinue = (e) => {
    ...
    if (!Orgin || !destination) {
      Alert.alert(
        "Validation Error",
        "Please select both origin and destination before continuing."
      );
      return;
    }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.Header}>
        <Text style={styles.HeaderText}>ETIX</Text>
        <TouchableOpacity
      ...
      <Modal1 visible={modalVisible} onClose={closeModal}>
        ...
        >
          ...
          >
            <Text style={styles.googleLoginText}>Close</Text>
          </TouchableOpacity>
        </View>
      </Modal1>
      <View className="h-full" style={{ backgroundColor: "white" }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              <TouchableOpacity
                ...
                style={styles.googleLoginButton}
              >
                <Text style={styles.googleLoginText}>View Guides</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View style={styles.loginContainer}>
            ...
            <View
              className="w-full"
              style={{ flex: 1, position: "relative", top: "-10%" }}
            >
              <View style={{ justifyContent: "flex-start", marginLeft: "10%" }}>
                <Text
                  style={{ fontSize: 16, fontWeight: "800", color: "#035B94" }}
                >
                  Popular Routes
                </Text>
              </View>
